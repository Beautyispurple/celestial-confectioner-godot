...
const MAJOR_JUMP_POINTS: Array[Dictionary] = [
	...
	{"name": "Intro: Panic choice – 5 things (Sensory Sifting unlock)", "timeline": "intro_sequence", "label": "prologue_panic_choice_5things"},
...
const UNLOCK_PATHS: Array[Dictionary] = [
	...
	{
		"name": "Unlock: Sensory Sifting (5 things path)",
		"timeline": "intro_sequence",
		"label": "prologue_panic_choice_5things",
		"vars": {"sensory_sifting_unlocked": 1},
	},
	{
		"name": "Unlock: Dragee toolkit (jump to Huck gate; call still runs in timeline)",
		"timeline": "day_0",
